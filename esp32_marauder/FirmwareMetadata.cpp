...
// Mini V3 deliberately has a distinct Eternal identity. Other targets retain
// their normal hardware name so merely compiling this shared source does not
// mislabel their binaries.
